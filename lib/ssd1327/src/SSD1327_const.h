...
constexpr uint8_t SET_DISP_MODE_NORMAL = 0xA4;
constexpr uint8_t SET_DISP_MODE_ALL_ON = 0xA5;
constexpr uint8_t SET_DISP_MODE_ALL_OFF = 0xA6;
constexpr uint8_t SET_DISP_MODE_INVERSE = 0xA7;
